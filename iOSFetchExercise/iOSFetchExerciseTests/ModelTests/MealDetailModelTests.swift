...
class MealDetailModelTests: XCTestCase {
    // Test decoding a MealDetailModel from JSON
    func testMealDetailModelDecoding() throws {
        ...
        // Verify that ingredients and measurements are correctly paired
        ...
        // Verify that tags are correctly split into an array
        XCTAssertEqual(mealDetail.tagsArray, ["Tag1", "Tag2", "Tag3"])
    }
    
    // Test encoding and then decoding a MealDetailModel
